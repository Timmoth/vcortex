...
public readonly struct LayerData
{
    ...
    public LayerData(int numInputs, int numOutputs, int activationInputOffset, int activationOutputOffset, int gradientOffset, int nextLayerErrorOffset, int currentLayerErrorOffset, int parameterOffset, int biasOffset, int inputWidth, int inputHeight, int outputWidth, int outputHeight, int inputChannels, int outputChannels, int numKernels, int kernelSize, int poolSize)
    {
        NumInputs = numInputs;
